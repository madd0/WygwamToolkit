...
using PhoneTester.Resources;
using Wygwam.Windows.Phone.Security;
using Wygwam.Windows.Security;
using Wygwam.Windows.Phone.Managers;
using Wygwam.Windows;
using Wygwam.Windows.Phone;
...
namespace PhoneTester
{
    public partial class App : Application
    {
        ...
        private async void SecurePasswordTester()
        {
            ...
            credential.Username = "micka";
            credential.Password = "poney";
            credential.Token = "42";
        ...
        private void NetworkTester()
        {
            NetworkManager manager = new NetworkManager();
            manager.InternetConnectionChanged += (e, a) =>
                {
                    Debug.WriteLine("Connection Changed =>" + a.IsConnected + " type " + a.ConnectionType);
                };

            Debug.WriteLine("Connection Start =>" + manager.IsNetworkAvailable + " type " + manager.ConnectionType);
        }
